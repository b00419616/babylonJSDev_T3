import { Scene, ArcRotateCamera, Vector3, DirectionalLight, MeshBuilder, Mesh, Color3, ShadowGenerator, StandardMaterial, Texture, HemisphericLight, SceneLoader, ActionManager, ExecuteCodeAction } from "@babylonjs/core";
import { TransformNode } from "@babylonjs/core/Meshes/transformNode";
import "@babylonjs/loaders/glTF";
function createArcRotateCamera(scene) {
    const camera = new ArcRotateCamera("camera1", (5 * Math.PI) / 4, Math.PI / 4, 50, new Vector3(0, 5, 0), scene);
...
export default function createScene3(engine) {
